...
public class EmployDao {
    public static List<Employee> getEmployees(){
        ...
        employeeList.add(new Employee(111, "Jiya Brein", 78, "Female", "HR", 2011, 25.0, Arrays.asList("jiya@gmail","jiya@yahoo")));
        employeeList.add(new Employee(122, "Paul Niksui", 33, "Male", "Sales And Marketing", 2015, 13500.0,Arrays.asList("paul@gmail","paul@yahoo")));
